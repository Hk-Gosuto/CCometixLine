...
const packageMap = {
  ...
  'win32-ia32': '@gosuto/ccline-win32-x64', // Use 64-bit for 32-bit systems
};
...
if (!packageName) {
  ...
  console.error(
    'Supported platforms: darwin (x64/arm64), linux (x64/arm64), win32 (x64)'
  );
  console.error(
    'Please visit https://github.com/Haleclipse/CCometixLine for manual installation'
  );
  process.exit(1);
}
...
if (!fs.existsSync(binaryPath)) {
  ...
  console.error('Please try reinstalling: npm install -g @gosuto/ccline');
